...
- Tests 4 models (SLS, Maxwell, Kelvin-Voigt, Dashpot) and 2 probes.
...
# CONFIGURATION
# =============================================================================
BASE_OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "simulated_data")
...
def main():
    ...
    for i, case in enumerate(test_cases):
        ...
        # At t=0, this is 0 for n>1 (Spherical/Conical) and v for n=1 (Cylindrical)
